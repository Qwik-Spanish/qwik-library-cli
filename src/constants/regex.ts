import { IRegexOptions } from '../interfaces/regex.interface';

export const EMAIL_REGEX: IRegexOptions = {
  pattern: /^((?!\.)[\w-_.]*[^.])(@\w+)(\.\w+(\.\w+)?[^.\W])$/gm,
  message:
    'The email format is not correct, add an email like this example: anartz@mugika.com',
};

export const NAME_PACKAGE_REGEX: IRegexOptions = {
...
export const WEBPAGE_REGEX: IRegexOptions = {
